...
import com.mercury.gateway.model.AccessRecord;
...
public class LogFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        accessRecord.setTargetUri(targetUri != null ?  targetUri.toString() : null);
    ...
    private void writeAccessRecord(AccessRecord accessRecord) {
        ...
        log.info("\n\n start------------------------------------------------- \n " +
                        ...
                        "请求体:{}\n " +
                        "end------------------------------------------------- \n ",
                accessRecord.getPath(), accessRecord.getScheme(), accessRecord.getMethod(), accessRecord.getTargetUri(),
                accessRecord.getHeaders(), accessRecord.getRemoteAddress(), accessRecord.getFormData(),
